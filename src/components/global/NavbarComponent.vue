<template>
  ...
  >
    <div class="bg-white w-full lg:w-1/3 p-6 rounded-lg shadow-lg relative">
      <button
        @click="closePopup"
      ...
      <form @submit.prevent="login">
        <div class="mb-4">
          <label for="username" class="block text-gray-800 font-semibold mb-1"
            >Username</label
          >
          <input
            type="text"
        ...
        <div class="mb-4">
          <label for="password" class="block text-gray-800 font-semibold mb-1"
            >Password</label
          >
          <input
            type="password"
